<header>
        <nav style="box-sizing: border-box;border-bottom: 1px solid #E6E8EB;" class="navbar navbar-expand-md navbar-toggleable-md navbar-light bg-white box-shadow mb-3">
            <div class="container-fluid">
                <a href="/autoplac%20mvc%20projekat/public/home" class="navbar-brand"><img class="logo" src="/autoplac%20mvc%20projekat/public/img/logo.png" alt="logo"></a>
                    ...
                    <ul class="navbar-nav flex-grow-1 justify-content-end">
                        ...
                        <?php 
                            if(isset($_SESSION['email'])){
                                ...
                                echo '<li class="ms-md-3 me-md-3 mt-2 mb-2 mt-md-0 mb-md-0 nav-item">
                                    <a href="/autoplac%20mvc%20projekat/public/users/login" type="button" style="padding:7px"  class="btn rounded btn-secondary ">Prijavi se</a>
                                </li>';
                                echo '<li class="ms-md-3 me-md-3 mt-2 mb-2 mt-md-0 mb-md-0  nav-item">
                                    <a type="button" class="btn rounded btn-primary" style="padding:7px" href="/autoplac%20mvc%20projekat/public/users/register" >Registruj se</a>
                                </li>';
                            }
                        ?>
                    </ul>
